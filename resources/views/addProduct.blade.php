...
@section('content')
    ...
    <div class="portlet light bordered col-xs-12" id='datasection'
         style="padding-bottom: 3em; min-height: 535px; padding-top: 3em">
        ...
        <div class="col-md-8">
            ...
            {!! Form::open(['url'=>'produit/add', 'role'=>'form ','class'=>'form-horizontal ', 'method'=>'post', 'style'=>'margin-top:0em; margin-bottom: 3em','id'=>'formAdd']) !!}
                        ...
                        <div class="col-sm-9 col-sm-offset-1" style="padding:0">
                            ...
                            <div class="form-group col-xs-12" style="margin-bottom: 1em; padding-left:0">
                                ...
                                <div class="col-md-12" style="padding: 0;">
                                    <input id="nom"  name="nom" type="text" class="form-control" value="{{old('nom')}}" placeholder="nom du produit">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12" style="margin-bottom: 1em; padding-left:0">
                                ...
                                <div class="col-md-12" style="padding: 0;">
                                    <input id="description"  name="description" type="text" class="form-control"  value="{{old('description')}}" placeholder="description" >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12" style="margin-bottom: 1em; padding-left:0">
                                ...
                                <div class="col-md-12" style="padding: 0;">
                                    <input id="letterRange"  name="letterRange" type="text" class="form-control"  value="{{old('letterRange')}}" placeholder="letter range" >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12" style="margin-bottom: 1em; padding-left:0">
                                ...
                                <div class="col-md-12" style="padding: 0;">
                                    <input id="unitCapacity"  name="unitCapacity" type="text" class="form-control"  value="{{old('unitCapacity')}}" placeholder="unit capacity" >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12" style="margin-bottom: 1em; padding-left:0">
                                ...
                                <div class="col-md-12" style="padding: 0;">
                                    <input id="capacityQuantity"  name="capacityQuantity" type="text" class="form-control"  value="{{old('capacityQuantity')}}" placeholder="capacity quantity" >
                                </div>
                            </div>
...
@section ('page_javascript')
    ...
    <script type="text/javascript">
        $(function () {
            $('input#nom').on('keyup',function(e){
                if (e.keyCode == 13) {
                    e.preventDefault();
                    return false;
                }
                var valeur=$('input#nom').val();
                var reg = new RegExp("[^a-z]", "gi" );
                if(valeur.match(reg)) {
                    $('#warn').html("<span style='color: red;'>Attention ! Le champ nom ne doit contenir que des lettres !</span>");
                } else {
                    $('#warn').html("");
                }
            });
